...
insert into livros (id, livro, autor, sexoautor, numpag, editora, valorcapa, kindle, ano) 
values (null, "Me Poupe!", "Nathalia Arcuri", "Feminio", 176, "Sextante", "32,86", "17,09", "2018");
...
select livro, editora, sexoautor 
from  livros 
where Id <11 and sexoautor like 'masculino';

-- 4 - Trazer o nome do livro, número de páginas do livro e autores do sexo feminino
select livro , sexoautor , numpag 
from livros 
where Id <11 and sexoautor like '%f%';
...
from livros 
where Id <11 and ano like 2017;

-- 6 - Trazer o nome dos autores do sexo masculino com livros publicados pela editora Sextante ou pela editora Altas Books;
select autor, sexoautor, editora 
from livros 
where Id <11 and sexoautor like 'masculino' and editora in ('Sextante' , 'Alta books');
